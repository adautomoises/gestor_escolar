<?php
  ...
  $param = array("action=getAlunosTurma&ano=20211&escola=1&grau_serie=3&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=4&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=5&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=11&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=12&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=13&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=14&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=15&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=16&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=17&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=17&turno=M&turma=2&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=18&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=19&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=21&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=22&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=23&turno=M&turma=1&status=C","action=getAlunosTurma&ano=20211&escola=1&grau_serie=24&turno=M&turma=1&status=C");
  for ($i=0; $i < 17; $i++) { 
    $params[$i] = new params();
    $params[$i]->link = $param[$i];
  }
?>
